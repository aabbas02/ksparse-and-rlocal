...
stringTitle = ['Rng3_Large_Eta_Iter_r_',num2str(r),'_n_',num2str(n),'_m_',num2str(m),'_d_',num2str(d),'_MC_',num2str(MC),'_ID_',num2str(ID)];
...
stringTitle = ['Rng3_ Large_Eta_Time_r_',num2str(r),'_n_',num2str(n),'_m_',num2str(m),'_d_',num2str(d),'_MC_',num2str(MC),'_ID_',num2str(ID)];
exportgraphics(gcf,[stringTitle,'.pdf']) 
